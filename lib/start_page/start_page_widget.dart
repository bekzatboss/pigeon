...
class _StartPageWidgetState extends State<StartPageWidget> {
  ...
  void initState() {
    ...
    _model.phoneNumberRegTextController ??= TextEditingController();
    _model.phoneNumberRegFocusNode ??= FocusNode();
          ...
          child: Column(
            ...
            children: [
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              8.0, 0.0, 8.0, 0.0),
                          child: TextFormField(
                            controller: _model.phoneNumberRegTextController,
                            focusNode: _model.phoneNumberRegFocusNode,
                            autofocus: true,
                            obscureText: false,
                            decoration: InputDecoration(
                              ...
                              onPressed: () async {
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: const Text(
                                          'Номер необходим для связи с исполнителем или отправителем'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          if (!((_model.emailTextController.text != '') &&
                              ...
                              (_model.phoneNumberRegTextController.text !=
                                      ''))) {
                            await showDialog(
                              context: context,
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  title: const Text('Заполните все строки'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
                                          Navigator.pop(alertDialogContext),
              ...
              InkWell(
                ...
                onTap: () async {
                  await launchURL('https://www.faraday.kz/pigeon-policy');
                },
                child: Text(
